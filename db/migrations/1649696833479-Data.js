module.exports = class Data1649696833479 {
  name = 'Data1649696833479'

  async up(db) {
    await db.query(`CREATE TABLE "treasury_proposal" ("id" character varying NOT NULL, "value" numeric NOT NULL, "beneficiary" text NOT NULL, "status" character varying(8) NOT NULL, CONSTRAINT "PK_99099b9e22458fa003fcec56e70" PRIMARY KEY ("id"))`)
